...
if __name__ == '__main__':
    student_1 = Student("Petrov", "Petr", "Petrovich", Path("C:/Users/homei/OneDrive/Рабочий стол/DeepPythonLection/homework_12/lessons.csv"))
    ...
    student_2 = Student("Ivanov", "Ivan", "Ivanovich", Path('C:/Users/homei/OneDrive/Рабочий стол/DeepPythonLection/homework_12/lessons.csv'))
